$(document).ready(function () {
    ...
    var focus_slider = $("#Focus_Slider");
    var focus = $("#Focus");
    focus_slider.attr("data-slider-min", 0.7).attr("data-slider-max", 1).attr("data-slider-step", 0.001).attr("data-slider-value", Focus).attr("data-slider-tooltip", "hide").slider({});
    bindSliderValParam(focus_slider, focus, "Focus");

    var motionBlur_slider = $("#motionBlur_slider");
    var motionBlur_val = $("#motionBlur");
    motionBlur_slider.attr("data-slider-min", 0.0).attr("data-slider-max", 0.7).attr("data-slider-step", 0.001).attr("data-slider-value", motionBlur).attr("data-slider-tooltip", "hide").slider({});
    bindSliderValParam(motionBlur_slider, motionBlur_val, "motionBlur");
    ...
    var checkGlossyElem = $('#checkGlossySelect');
    initCheckbox(checkGlossy, checkGlossyElem);

    var checkTranslucentElem = $('#checkTranslucentSelect');
    initCheckbox(checkTranslucent,checkTranslucentElem);
