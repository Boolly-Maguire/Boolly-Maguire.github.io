...
window.onload = function init() {
    ...
    FocusLoc = gl.getUniformLocation(program,"Focus");
    motionBlurLoc = gl.getUniformLocation(program,"motionBlur");
    ...
    checkGlossyLoc = gl.getUniformLocation(program,"checkGlossy");
    checkTranslucentLoc = gl.getUniformLocation(program,"checkTranslucent");
...
function render() {
    ...
    var checkGlossyElem = $('#checkGlossySelect:checked');
    checkGlossy = (checkGlossyElem.val()) ? 1 : 0;

    var checkTranslucentElem = $('#checkTranslucentSelect:checked');
    checkTranslucent = (checkTranslucentElem.val()) ? 1 : 0;
    ...
    gl.uniform1f(FocusLoc, Focus);
    gl.uniform1f(motionBlurLoc, motionBlur);
    ...
    gl.uniform1i(checkGlossyLoc, checkGlossy);
    gl.uniform1i(checkTranslucentLoc, checkTranslucent);
